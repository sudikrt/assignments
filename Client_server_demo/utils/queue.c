...
queue_t* queue_new ()
{
        ...
        obj -> head = (q_node_t*) calloc (1, sizeof (q_node_t));
        obj -> head -> c_request = (void*) calloc (1, sizeof (void));
        obj -> tail = (q_node_t*) calloc (1, sizeof (q_node_t));
        obj -> tail -> c_request = (void*) calloc (1, sizeof (void));
        obj -> head = NULL;
        obj -> tail = NULL;
        obj -> max = 0;
        return obj;
