...
int
delete_from_list (list_t *list_obj, list_cbk_t arg) {
...
/*
 * Function to check the list is full or not
 * Input:
 *      list_t* arg     :       Specifies the reference to the list.
 * Output:
 *      int ret         :       if list is full then returns 1 otherwise 0.
 * */
